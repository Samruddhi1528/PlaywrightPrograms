//referer - passing previous URL. This is an optional parameter.Used in security to track the user's journey.
//every pag has referer. Devtools -> Header -> Referer  
...
test("navigate with custom referer", async ({ page }) => {
    ...
    await page.goto("https://app.com/landing", {
        referer: "https://google.com/search?q=testing+academy" //previous URL
    });
